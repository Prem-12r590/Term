<%-- 
    ...
    Created on : May 12, 2023, 12:20:56 PM
    Author     : VIVEKJHA
--%>

<%@page import="java.util.ArrayList"%>
<%@page import="dao.TerminationDao"%>
<%@page import="dao.ResinationDao"%>
                                    ...
                                    <thead>
                                     ...
                                     <%      
                                           String terminationCd="";
                                            ...
                                            ArrayList<ArrayList<String>> arr=dao.selectAllTermination();
                                            for(ArrayList<String> d : arr){
                                              terminationCd=d.get(0);
                                    %>
                                    <tbody>
                                        <tr>
                                            <td><%=d.get(0)%></td>
                                            ...
                                            <td class="text-end">
                                                <div class="dropdown dropdown-action">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#edit_termination" onclick=getmodeldata('<%=d.get(0)%>');>><i class="fa fa-pencil m-r-5"></i> Edit</a>
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="../TerminationServlet?action=insert" method="post">
                                    <div class="form-group">
                                        <label>Terminated Employee <span class="text-danger">*</span></label>
                                        <input class="form-control" type="text" name="TEMployee">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="cal-icon">
                                            <input type="text" class="form-control datetimepicker" name="TerminationDate">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label>Reason <span class="text-danger">*</span></label>
                                        <textarea class="form-control" rows="4" name="TerminationReason"></textarea>
                                    </div>
                                    <div class="form-group">
                                        <label>Notice Date <span class="text-danger">*</span></label>
                                        <div class="cal-icon">
                                            <input type="text" class="form-control datetimepicker" name="TNoticeDate">
                                        </div>
                                    </div>
                ...
                <div id="edit_termination" class="modal custom-modal fade" role="dialog">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                  <form action="../TerminationServlet?action=update" method="post">
                                    <input type="hidden" name="updateTerminationcd" id="updateTerminationcd">
                                    <div class="form-group">
                                        <label>Terminated Employee <span class="text-danger">*</span></label>
                                        <input class="form-control" type="text" name="updateTEMployee" id="updateTEMployee">
                                    </div>
                                    <div class="form-group">
                                        <label>Termination Type <span class="text-danger">*</span></label>
                                        <div class="add-group-btn">
                                            <select class="select" name="updateterminationType" id="updateterminationType">
                                                <option value="Misconduct">Misconduct</option>
                                                <option value="Others">Others</option>
                                            </select>
                                    ...
                                    <div class="form-group">
                                        <label>Termination Date <span class="text-danger">*</span></label>
                                        <div class="cal-icon">
                                            <input type="text" class="form-control datetimepicker" name="updateTerminationDate"  id="updateTerminationDate">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label>Reason <span class="text-danger">*</span></label>
                                        <textarea class="form-control" rows="4" name="updateTerminationReason" id="updateTerminationReason"></textarea>
                                    </div>
                                    <div class="form-group">
                                        <label>Notice Date <span class="text-danger">*</span></label>
                                        <div class="cal-icon">
                                            <input type="text" class="form-control datetimepicker" name="updateTNoticeDate" id="updateTNoticeDate">
                                        </div>
                                    </div>
                                    <div class="submit-section">
                                        <button type="submit" class="btn btn-primary submit-btn">Submit</button>
                        ...
                        <div class="modal-content">
                            <div class="modal-body">
                                ...
                                <div class="modal-btn delete-action">
                                    <div class="row">
                                        <div class="col-6">
                                            <a href="../TerminationServlet?action=delete&terminationCd=<%=terminationCd%>" class="btn btn-primary continue-btn">Delete</a>
                                        </div>
                                        <div class="col-6">
        ...
        <script src="assets/js/app.js"></script>
           ...
           <script>
                                                           ...
                                                           function getmodeldata(id) {
                                                               ...
                                                               $.ajax({
                                                                   url: '../TerminationServlet?action=search',
                                                                   type: 'POST',
                                                                   data: {'depid': id},
                                                                   success: function (e) {
                                                                      
                                                                       var e1  =e.split("#");
                                                                       document.getElementById("updateTEMployee").value = e1[0].trim();
                                                                       document.getElementById("updateterminationType").value = e1[1].trim();
                                                                       document.getElementById("updateTerminationDate").value = e1[2].trim();
                                                                       document.getElementById("updateTerminationReason").value = e1[3].trim();
                                                                       document.getElementById("updateTNoticeDate").value = e1[4].trim();
                                                                       document.getElementById("updateTerminationcd").value = id;
                                                                   }
